...
# Color Memory: qwen3-vl-8b (both continuous and named variants)
...
check_existing_result() {
    local n_images="$1"
    local variant="$2"
    [ -f "$RESULTS_DIR/results_color_${variant}_qwen3-vl-8b_n${n_images}.json" ]
}
